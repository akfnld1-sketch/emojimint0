...
(function () {
  ...
  // 세분화 캐릭터 다국어 라벨 (세분화 ID → ko/en/ja/zh)
  const DETAIL_LABELS = {
    // --- 동물: 강아지 ---
    animal_dog_maltese: {
      ko: "말티즈 강아지",
    ...
    animal_rabbit_default: {
      ko: "통통한 토끼 캐릭터",
      en: "Chubby rabbit character",
      ja: "ふっくらウサギキャラ",
      zh: "圆润的兔子角色"
    },
    animal_bear_default: {
      ko: "곰돌이 캐릭터",
      en: "Teddy bear character",
      ja: "クマさんキャラ",
      zh: "小熊角色"
    },
    animal_fox_default: {
    ...
    human_male_elementary: {
      ko: "남자 초등학생",
      en: "Boy elementary student",
      ja: "男子小学生",
      zh: "男小学生"
    },
    human_male_middle: {
      ko: "남자 중학생",
      en: "Boy middle-school student",
      ja: "男子中学生",
      zh: "男初中生"
    },
    human_male_high: {
      ko: "남자 고등학생",
      en: "Boy high-school student",
      ja: "男子高校生",
      zh: "男高中生"
    },
    human_male_univ: {
      ko: "남자 대학생",
      en: "Male college student",
      ja: "男子大学生",
      zh: "男大学生"
    },
    ...
    human_female_manual: {
      ko: "여자 현장 근로자",
      en: "Female manual worker",
      ja: "女性現場作業員",
      zh: "女体力劳动者"
    },
    human_female_parttime: {
      ko: "여자 알바생",
      en: "Female part-timer",
      ja: "女性アルバイト",
      zh: "女兼职生"
    },
    human_female_child: {
    ...
    human_female_elementary: {
      ko: "여자 초등학생",
      en: "Girl elementary student",
      ja: "女子小学生",
      zh: "女小学生"
    },
    human_female_middle: {
      ko: "여자 중학생",
      en: "Girl middle-school student",
      ja: "女子中学生",
      zh: "女初中生"
    },
    human_female_high: {
      ko: "여자 고등학생",
      en: "Girl high-school student",
      ja: "女子高校生",
      zh: "女高中生"
    },
    human_female_univ: {
    ...
    // --- 음식 ---
    food_breakfast_default: {
      ko: "아침 식사 세트 캐릭터",
      en: "Breakfast meal character",
      ja: "朝食セットキャラ",
      zh: "早餐组合角色"
    },
    food_lunch_default: {
      ko: "점심 식사 세트 캐릭터",
      en: "Lunch meal character",
      ja: "昼食セットキャラ",
      zh: "午餐组合角色"
    },
    food_dinner_default: {
      ko: "저녁 식사 세트 캐릭터",
      en: "Dinner meal character",
      ja: "夕食セットキャラ",
      zh: "晚餐组合角色"
    },
    food_dessert_default: {
      ko: "디저트 캐릭터",
      en: "Dessert character",
      ja: "デザートキャラ",
      zh: "甜点角色"
    },
    ...
    mini_animal_bee: {
      ko: "미니 꿀벌 캐릭터",
      en: "Mini bee character",
      ja: "ミニハチキャラ",
      zh: "迷你蜜蜂角色"
    },
    mini_animal_ant: {
      ko: "미니 개미 캐릭터",
      en: "Mini ant character",
      ja: "ミニアリキャラ",
      zh: "迷你蚂蚁角色"
    },
    mini_animal_beetle: {
      ko: "미니 풍뎅이 캐릭터",
      en: "Mini beetle character",
      ja: "ミニカブトムシキャラ",
      zh: "迷你甲虫角色"
    },
    mini_animal_stag: {
      ko: "미니 사슴벌레 캐릭터",
      en: "Mini stag beetle character",
      ja: "ミニクワガタキャラ",
      zh: "迷你锹形虫角色"
    },
    ...
    mini_human_male_helmet: {
      ko: "미니 남자 헬멧 캐릭터",
      en: "Mini male character with helmet",
      ja: "ミニ男性ヘルメットキャラ",
      zh: "迷你戴头盔男角色"
    },
    mini_human_female_helmet: {
      ko: "미니 여자 헬멧 캐릭터",
      en: "Mini female character with helmet",
      ja: "ミニ女性ヘルメットキャラ",
      zh: "迷你戴头盔女角色"
    },
    ...
    mini_special_robot: {
      ko: "미니 로봇 캐릭터",
      en: "Mini robot character",
      ja: "ミニロボットキャラ",
      zh: "迷你机器人角色"
    },
    mini_special_anime_male: {
      ko: "애니풍 남자 미니 캐릭터",
      en: "Anime-style mini male character",
      ja: "アニメ風ミニ男性キャラ",
      zh: "动漫风迷你男角色"
    },
    mini_special_anime_female: {
      ko: "애니풍 여자 미니 캐릭터",
      en: "Anime-style mini female character",
      ja: "アニメ風ミニ女性キャラ",
      zh: "动漫风迷你女角色"
    },
    mini_special_ghost: {
      ko: "유령 미니 캐릭터",
      en: "Ghost mini character",
      ja: "ゴーストミニキャラ",
      zh: "幽灵迷你角色"
    },
    mini_special_angel: {
      ko: "천사 미니 캐릭터",
      en: "Angel mini character",
      ja: "天使ミニキャラ",
      zh: "天使迷你角色"
    },
    mini_special_devil: {
      ko: "악마 미니 캐릭터",
      en: "Devil mini character",
      ja: "悪魔ミニキャラ",
      zh: "恶魔迷你角色"
    }
  };

  // 감정·상황 세트 정보 (라벨만, 실제 문장/내용은 서버)
  ...
  // 의상 30종 (auto 포함, 라벨만 프론트에 노출)
  const OUTFIT_INFO = {
    auto: {
      id: "auto",
      labels: {
        ko: "선택 안 함 (세트 기본 옷)",
        en: "No override (set default outfit)",
        ja: "指定なし（セット基本衣装）",
        zh: "不指定（套装默认服装）"
      }
    },
    ...
    workwear_construction: {
      id: "workwear_construction",
      labels: {
        ko: "작업복 (노가다 느낌)",
        en: "Construction workwear",
        ja: "作業服",
        zh: "工地工作服"
      }
    },
  ...
  const COLOR_INFO = {
    auto: {
      ...
      labels: {
        ko: "선택 안 함 (세트 기본 색상)",
        en: "No override (set default colors)",
        ja: "指定なし（セット基本カラー）",
        zh: "不指定（套装默认颜色）"
      }
    },
  ...
  const PROP_ITEMS = [
    ...
    },
    {
      ...
      prompts: {
        ko: "손에는 따뜻한 머그컵 커피를 들고 있고",
        en: "holding a warm coffee mug in one hand",
        ja: "片手に温かいマグカップのコーヒーを持っていて",
        zh: "一只手端着一杯温热的咖啡"
      }
    },
    {
      ...
      prompts: {
        ko: "한 손에는 스마트폰을 들고 화면을 바라보며",
        en: "holding a smartphone and looking at the screen",
        ja: "片手にスマホを持ち画面を見つめながら",
        zh: "一手拿着手机看着屏幕"
      }
    },
    {
      ...
      prompts: {
        ko: "앞에는 리본이 달린 작은 선물 상자가 놓여 있고",
        en: "with a small gift box with a ribbon placed in front",
        ja: "前にはリボン付きの小さなプレゼント箱が置かれていて",
        zh: "面前放着一个系着丝带的小礼盒"
      }
    },
    {
      ...
      prompts: {
        ko: "앞에 노트북이 펼쳐져 있고 그 앞에 앉아 있으며",
        en: "sitting in front of an open laptop",
        ja: "開いたノートPCの前に座っていて",
        zh: "坐在打开的笔记本电脑前"
      }
    },
    {
      ...
      prompts: {
        ko: "귀에는 작은 이어폰을 꽂고 음악을 들으며",
        en: "wearing small earphones and listening to music",
        ja: "耳に小さなイヤホンをつけて音楽を聴きながら",
        zh: "耳朵里戴着小耳机听音乐"
      }
    },
    {
      ...
      prompts: {
        ko: "한 손에 접힌 우산을 들고 있고",
        en: "holding a folded umbrella in one hand",
        ja: "片手に畳んだ傘を持っていて",
        zh: "一只手拿着折叠的雨伞"
      }
    },
    {
      ...
      prompts: {
        ko: "두 손으로 작은 꽃다발을 꼭 안고 있으며",
        en: "hugging a small flower bouquet with both hands",
        ja: "両手で小さな花束をぎゅっと抱えていて",
        zh: "双手紧紧抱着一束小花"
      }
    },
    {
      ...
      prompts: {
        ko: "포근한 담요를 몸에 두르고 편안한 느낌으로",
        en: "wrapped in a cozy blanket, looking relaxed",
        ja: "ふかふかのブランケットにくるまれてリラックスした様子で",
        zh: "裹着柔软的毯子，表情放松"
      }
    },
    {
      ...
      prompts: {
        ko: "작은 베개를 끌어안고 포근하게 기대어 있으며",
        en: "snuggling against a small pillow",
        ja: "小さな枕を抱きしめてもたれかかっていて",
        zh: "抱着小枕头轻轻依靠着"
      }
    }
  ];
